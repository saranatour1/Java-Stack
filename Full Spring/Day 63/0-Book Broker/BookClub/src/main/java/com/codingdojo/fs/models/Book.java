...
public class Book {
  ...
  // borrower 
  //1 book can only be borrowed by one user
  // while one user can borrow as many books 
  @ManyToOne(fetch = FetchType.LAZY)
  @JoinColumn(name="borrower_id")
  private User user_that_borrowed;


  // public Book(User user_that_borrowed) {
  //   this.user_that_borrowed = user_that_borrowed;
  // }

  public User getUser_that_borrowed() {
    return user_that_borrowed;
  }

  public void setUser_that_borrowed(User user_that_borrowed) {
    this.user_that_borrowed = user_that_borrowed;
  }
