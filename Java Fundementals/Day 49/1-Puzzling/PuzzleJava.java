...
public class PuzzleJava {
   ...
   * The array should be the length passed in as an int. Return the array of
   * passwords.
   * 
   * 
   */
  ...
  // generate an aray of passwords, where each element is supposed to have 8
  // charecters of passwords in it
