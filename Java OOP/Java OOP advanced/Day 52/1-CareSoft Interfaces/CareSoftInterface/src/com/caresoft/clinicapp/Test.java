...
public class Test {
    public static void main(String[] args) {
        ...
        String authTest1 = doctor10.accessAuthorized(1234) ? "FAIL" : "PASS"; // pass
        System.out.printf("Physician auth test 1: %s\n", authTest1);

        String authTest2 = doctor10.accessAuthorized(1) ? "PASS" : "FAIL"; // pass
        ...
        String pinTest4 = roseTyler.assignPin(424242) ? "PASS" : "FAIL"; // pass
        System.out.printf("Admin pin assign test 2: %s\n", pinTest4);

        String authTest3 = roseTyler.accessAuthorized(1234) ? "FAIL" : "PASS"; // pass
        System.out.printf("Admin auth test 1: %s\n", authTest3);

        String authTest4 = roseTyler.accessAuthorized(1234) ? "FAIL" : "PASS"; // pass
        System.out.printf("Admin auth test 1: %s\n", authTest4);

        String authTest5 = roseTyler.accessAuthorized(2) ? "PASS" : "FAIL"; // pass
        ...
        System.out.println(donnaNoble.reportSecurityIncidents()); // failed :D;D
